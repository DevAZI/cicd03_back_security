        ...
        http.cors((corsCustomizer ->
                corsCustomizer.configurationSource(new CorsConfigurationSource()
                {
                    ...
                    public CorsConfiguration getCorsConfiguration(HttpServletRequest request) {
                        ...
                        configuration.setAllowedOrigins(Arrays.asList("http://43.200.176.254", "http://43.200.176.254:80"));
                        configuration.setAllowedOrigins(Arrays.asList("http://kjmkosta.kro.kr", "https://kjmkosta.kro.kr"));
